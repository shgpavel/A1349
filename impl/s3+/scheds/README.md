...
This experimental tree contains the schedulers implemented in this repository:

- `c/scx_simple.c` and `c/scx_simple.bpf.c` provide the simple reference
  scheduler.
- `c/scx_eevdf.c` and `c/scx_eevdf.bpf.c` provide the heterogeneous-core EEVDF
  experiments.
