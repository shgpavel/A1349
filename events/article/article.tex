...
The ideal reference is a fluid system in which client $ i $ continuously
receives instantaneous share $ w_i/W(t) $.
...
Clients that have received less than their fluid-model share become
...
is the flexibility of the resulting solution. Any constant or formula can be
modified and tested without requiring a reboot, thanks to the sched\_ext framework.
